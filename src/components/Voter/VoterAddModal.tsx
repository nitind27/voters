...
interface VoterAddModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSuccess: (newVoter: voterdayatype) => void;
    preselectedColonyId?: string;
    preselectedColonyName?: string;
    preselectedHouseNumber?: string;
}

const VoterAddModal: React.FC<VoterAddModalProps> = ({
    isOpen,
    onClose,
    onSuccess,
    preselectedColonyId,
    preselectedColonyName,
    preselectedHouseNumber,
}) => {
    const [formData, setFormData] = useState({
        colony_id: preselectedColonyId || '',
        house_number: preselectedHouseNumber || '',
        first_name: '',
        middle_name: '',
        last_name: '',
        first_name_mr: '',
    ...
    }, [isOpen, preselectedColonyId, preselectedHouseNumber]);
    useEffect(() => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (newVoter) onSuccess(newVoter);
                ...
                >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            disabled
                            className="w-full p-2 border rounded border-gray-300 bg-gray-100 cursor-not-allowed"
                            placeholder="House number will be auto-selected"
                        />
                    </div>
